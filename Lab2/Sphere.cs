...
namespace Lab2
{
    ...
    class Sphere : CircleShape
    {
        ...
        public override double CalculateVolume()
        {
            ...
            return ((4.0 / 3.0) * Shape.PI * Math.Pow(base.Radius,3));
        }
        /// <summary>
        ...
        public override string ToString()
        {
            return string.Format("{0,-11}\t{1,10}\t{2,10}\t{3,-45}",
                                    this.GetType().Name, base.AreaCalculation.ToString("0.00"), base.VolumeCalculation.ToString("0.00"), $"{base.Radius.ToString("0.00")} r");
        }
    }
}
